...
try:
    ...
    logger.warning("pypdf not installed. PDF features will be limited.")
    PDF_AVAILABLE = False
...
try:
    ...
    logger.warning(
        "python-docx not installed. Word document features will be limited.")
...
╔═══════════════════════════════════════════════════════════╗
║                                                           ║
║   Enhanced Sample Processor - Interactive Demo            ║
║   ═════════════════════════════════════════════════       ║
║                                                           ║
║   Multi-format Grant Sample Processing & Style Matching   ║
║                                                           ║
╚═══════════════════════════════════════════════════════════╝
"""
...
def create_sample_files(demo_dir: Path = DEMO_DIR) -> Dict[str, List[Path]]:
    ...
    for grant_type in GRANT_TYPES:
        ...
        if DOCX_AVAILABLE:
            ...
            print_warning(
                "Word document creation skipped: python-docx not available")
...
def demo_hybrid_integration(processor):
    ...
    try:
        from utils.rag_utils import query_context, VECTOR_DB_DIR
        rag_available = True
    except ImportError:
        print_warning(
